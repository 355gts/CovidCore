...
namespace Covid.$ext_safeprojectname$.EventListeners
{
    public class ServiceEventListener : EventListener<CreateUser>
    {
        private readonly ILog _logger = LogManager.GetLogger(typeof(ServiceEventListener));
